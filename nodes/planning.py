...
if __name__ == '__main__':
    ...
    crrt = CRRT(state_space, svc, interp_fn, xytheta_distance, {'smooth_path': False, 'epsilon': 20, 'e_step': .25, 'smoothing_time': 10})
    
    start_q = [405, 100, 90]
    goal_q = [405, 800, 90]
    
    tsr = LineConstraintTSR([405, 100, 90], [405, 800, 90])
