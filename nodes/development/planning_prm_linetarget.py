...
if __name__ == '__main__':
    ...
    prm = CPRM(state_space, svc, interp_fn, xytheta_distance, {'smooth_path': False, 'ball_radius': 50, 'n_samples': 8000, 'k': 15})
    tsr = LineTargetingConstraintPRMTSR([405, 100], [1205, 100], [800, 500])
